...
def validate_data(values):
    """
    Inside the try, converts all string values into integets,
    Raises ValueError if string cannot be converted into int,
    or if there aren't exatly 6 values
    """
    try:
...
def update_worksheet(data, worksheet):
    ...
    worksheet_to_update.appendrow(data)
...
def calculate_surplus_data(sales_row):
    ...
    The surplus if defined as the sales figure subtracted from the stock:
